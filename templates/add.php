        ...
        <div id="app-content-wrapper">
            ...
            <div class="content-page" rel="OCDYT" style="display:none;">
                ...
                <div class="jumbotron">
                    <h5><?php print ($l->t ('Options')); ?></h5>
                    <div class="group-option">
                        <label for="option-yt-extractaudio"><?php print ($l->t ('Only Extract audio ?')); ?>
                          </label><input type="checkbox" id="option-yt-extractaudio" />&nbsp;<i>
                              <?php print ($l->t ('(Just extract the best audio quality)')); ?></i>
                    </div>
                    <div class="group-option">
